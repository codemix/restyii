...
<p>This generator generates a resource class for the specified database table.</p>
...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    ...
    <div class="row">
    <?php echo $form->labelEx($model,'commentsAsDescriptions'); ?>
    <?php echo $form->checkBox($model,'commentsAsDescriptions'); ?>
    <div class="tooltip">
        Whether comments specified for the table columns should be used as the new model's attribute descriptions.
    </div>
    <?php echo $form->error($model,'commentsAsDescriptions'); ?>
</div>
<?php $this->endWidget(); ?>
